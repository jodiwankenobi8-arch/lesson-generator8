...
- Active branch: main
- Current published continuation point: cd666f8 refine Inputs optional-support terminology and close the seam on current main
- Current validated local state: Materials upload-type visibility is closed on current main, the README current-truth summary is pushed, Inputs terminology alignment is pushed, Results blocked-state terminology alignment is pushed, Inputs optional-support terminology alignment is pushed, and this docs refresh matches the pushed repo truth
