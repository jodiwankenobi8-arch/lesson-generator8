...
describe("Results explainability rendering contracts", () => {
  ...
  it("renders selected curriculum/exemplar names and IDs from generated state with blueprint/trace alignment", () => {
    ...
    expect(traceabilityMarkup).toContain("How the exemplar shaped this lesson")
    expect(traceabilityMarkup).toContain("Lesson plan structure:")
    expect(traceabilityMarkup).toContain("Slide structure:")
    expect(traceabilityMarkup).toContain("Pacing and routines carried forward:")
  ...
  it("keeps the teacher-facing results package labels and order aligned", () => {
    ...
    expect(source).toContain("exemplarPayoffSummary.title")
    expect(source).toContain("exemplarPayoffSummary.lines.map")
    expect(source).toContain("<strong>{line.label}:</strong>")
    expect(source).toContain("exemplarPayoffSummary.note")
