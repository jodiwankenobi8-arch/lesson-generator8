# Lesson Generator 8 — GitHub Baseline and Hardening Handoff

- Date: 2026-03-17
- Repo: jodiwankenobi8-arch/lesson-generator8
- Chat purpose: review the current pushed GitHub baseline, reconcile it with the March 11 and March 13 project plans, evaluate SOPs and beginner workflow needs, and define the next continuation point for lesson-generator8.
...
- Broader OCR expansion, broad AI generation work, and more export breadth should come after trust/source-selection hardening.
...
## What was reviewed
- Code files:
  - GitHub-visible files and structure, including `README.md`, `package.json`, `src/pages/*`, `src/extraction/*`, `src/engine/*`
...
- Other evidence actually used:
  ...
  - GitHub activity screenshots provided by the user showing the pushed commit sequence on `main`
...
- The public repo structure does not exactly match the March 13 seam names; some seam mapping will need to be done against the real local tree before editing.
...
5. Add tests for noisy OCR / thin extraction / weak-structure cases.
...
- Command explicitly mentioned as the local continuation inspection point:
